...
from shipment.dataclasses.batch_shipment import BatchNameResponse, AssignBatchToShipmentParam, \
...
class BatchShipmentModelViewSet(viewsets.ModelViewSet):
    ...
    @swagger_auto_schema(
        ...
        request_body=AssignBatchToShipmentParam.serializer(),
        responses={200: ''}
    )
    @action(detail=False, methods=['POST'], url_path='assign')
    def assign_batch(self, request):
        assign_batch_to_shipment_param = AssignBatchToShipmentParam.from_post_request(request=request)
    ...
    def unassign_batch(self, request):
        ...
        BatchShipmentService().unassign_batch_shipments(
            unassign_batch_to_shipment_param=unassign_batch_to_shipment_param)
        return Response()
