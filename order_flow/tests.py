...
#         self.obj = OrderFlow.objects.first()
#         self.list_url = reverse('order-flow-list')
#         raw_data = '{\r\n    \"raw_json_data\": {\r\n  \"username\": \"frappet\",\r\n  \"doctor\": {\r\n    \"name\": ' \
#                    '\"Kazuya Sojo\",\r\n    \"license\": \"12345678\"\r\n  },\r\n  \"patient\": {\r\n    \"name\": ' \
#                    '\"Green Covid\",\r\n    \"cid\": \"1234567890123\",\r\n    \"phoneno\": \"0811234567\",' \
#                    '\r\n    \"hn\": \"123477889\",\r\n    \"address\": {\r\n      \"street\": \"123 ' \
...
#             self.client.get(reverse('order-flow-detail', kwargs={'pk': self.obj.pk}),
#                             content_type=json_content_type)
#         response = self.client.get('api/order-flows/', kwargs={'pk': self.obj.pk}, content_type=json_content_type)
...
#         with self.assertRaises(exceptions.NoReverseMatch):
#             self.client.put(reverse('order-flow-detail', kwargs={'pk': self.obj.pk}),
#                             self.valid_field, format="json")
#         response = self.client.put('api/order-flows/', kwargs={'pk': self.obj.pk}, content_type=json_content_type)
#         self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
#
...
#         shopping_link = OrderFlow.objects.create(**self.valid_field)
